...
const FormSection = () => {
  ...
  return (
    <div className="w-full max-w-screen-sm min-h-screen flex flex-col items-center py-12 px-4 bg-[#f3f3f3] relative">
        ...
        <div className="grid grid-cols-5 gap-2">
          <div className="text-[0.725rem] col-span-3 text-balance text-zinc-700">
            ...
            <p>
              ...
              kamu sekarang?, kalo lagi gamod atau capek boleh kamu abaikan kok
              hahaha
            </p>
            <p>semangat.</p>
          </div>
          <div className="col-span-2 rounded-xl items-center justify-center flex overflow-hidden">
            <img className="object-cover bg-center w-40" src="img/pt.gif"></img>
          </div>
        </div>
      </div>
